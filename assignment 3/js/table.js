...
window.onload = function (){
    var emailList = document.querySelector("#tableDiv")

    var tableString = '<table border="1px solid;">' + 
                            '<tr>' + 
                                '<th>' + 'First Name' + '</th>' +
                                '<th>' + 'Last Name' + '</th>' +
                                '<th>' + 'Age' + '</th>' +
                            ...
                            for (let i = 0; i < users.length; i++){
                                tableString += '<tr>' + '<td>' + users[i].first_name + '</td>' +
    ...
    emailList.innerHTML = tableString
}